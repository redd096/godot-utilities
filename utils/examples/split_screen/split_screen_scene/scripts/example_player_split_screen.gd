...
func _physics_process(delta: float) -> void:	
	...
	var input_dir: Vector2 = Input.get_vector("ui_left" + input_suffix, "ui_right" + input_suffix, "ui_up" + input_suffix, "ui_down" + input_suffix) if player_index >= -1 else Vector2.ZERO
